...
**Features:** settings, commandChannels, xp, decay, voice, levelRoles, logs, youtube, honeypot, reactionRoles, eventReminders, staffNotes.
...
4. **Admin gate**: `/xp`, `/leaderboard` public; others need `ManageGuild` (staff notes use `requireStaff`, currently ManageGuild-only until staff roles ship)
